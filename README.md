...
Plugin de WordPress que integra sitios corporativos con la plataforma Eventus para consultar y mostrar dispositivos medicos en tiempo real. Proporciona formularios accesibles, exportacion de datos y fichas detalladas listas para incrustar en cualquier pagina mediante shortcodes.
